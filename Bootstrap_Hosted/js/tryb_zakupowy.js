function trybZakupowy() {
	...
	xhr.onload = () =>{
		var lista="<table class='table table-striped table-bordered'><thead><tr><th scope='col'>Nazwa Produktu</th><th scope='col'>Kategoria Produktu</th><th scope='col'>Miara</th><th scope='col'>Ilość</th><th scope='col'>Ile kupujesz</th><th scope='col'>Potwierdź zakup</th></tr></thead>";
		var kategoria="";

function trybZakupowy() {
	...
	.then( function( result ) {
		var lista="<table class='tabelaZakupow'><tr><td>Nazwa Produktu</td><td>Kategoria Zakupowa</td><td>Miara</td><td>Ile kupujesz</td><td>Potwierdź zakup</td></tr>";
		var kategoria="";
		for(var i=0;i<result.length;i++)
		{
			...
			lista+="<tr><td>"+result[i].nazwaProduktu+"</td><td>"+result[i].miara+"</td><td>"+result[i].kategoriaZakupy+"</td><td><input type='number' id='"+result[i].objectIdProduktu+"' value='"+result[i].ilosc+"'></td><td><button onclick=buy('"+result[i].objectIdProduktu+"')>Kup</button></td></tr>";
		}
		lista+="</table>";
